...
namespace API.Controllers
{
    ...
    public class ExerciseController : ControllerBase
    {
        ...
        public IActionResult Add([FromBody] ClientExercise clientExercise)
        {
            ...
            Exercise exercise = (Exercise) _exerciseService.AddWithReturn(new Exercise { Name = clientExercise.Name, Description = clientExercise.Description, Recording = Recording });
